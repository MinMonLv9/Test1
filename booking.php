...
<?php
    if(isset($_POST['btnsend']))
    {
        ...
        $bookingmessage = $_POST['message'];

        $select = "SELECT * FROM booking where CustomerUsername='$customerusername'";
        ...
        if($count<0){
            ...
            $insert = "INSERT INTO booking(BookingDate,CustomerUsername,CustomerEmailAddress,Message,Policy)
            values('$bookingdate','$customerusername','$customeremailaddress','$bookingmessage','Yes')";

            $query = mysqli_query($connect,$insert);
            if($query)
            {
                echo "<script>alert('Your booking was recieved successfully. We will respond ASAP.')</script>";
...
<div class="section-title">
    <h2><span><a class="gallarylink" href="wanted.php">Second-Hand Products</a></span>
	<span><a href="booking.php" class="gallarylink">Booking</a></span></h2>
	</div>
						...
						<div class="row no-gutters mb-5">
							<div class="col-md-12">
								...
								<div class="mainheading">
										...
										<p class="lead">
											Feel free to ask about our second-hand products. We will respond ASAP.
										</p>
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="date" class="form-control" name="date" required placeholder="Subject">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
											...
											<div class="col-md-12">
												<div class="form-group">
													<input type="checkbox" name="agreement" require>
