...
<form class="form-inline my-2 my-lg-0" action="#" method="POST">
			<input class="form-control mr-sm-2" type="text" name="txtSearch" placeholder="Search Second Products ">
			<div style="display: none;">
			<button class="searchbotton" name="btnSearch"> Search</button>
			</div>
		</form>
</div>
<br>
    ...
    <div class="card">
		<form action="#" method="GET">
            <a href="ProductDetails.php?ProductID=<?php echo $ProductID ?>&qty=1">
                <img src="<?php echo $Image1 ?>" width='200px' height='200px'>
            </a>
 ...
 else
{
	...
	<div class="card-columns listrecent">
	<?php 
$query="SELECT * from Product WHERE EquipmentType='Second'
...
$count=mysqli_num_rows($result);
 ...
 if($count>0)
    ...
    for ($i=0; $i <$count ; $i+=5)
    {
        $query1="SELECT * from Product WHERE EquipmentType='Second'
